...
class Scoreboard():
    ...
    def __init__(self, game_settings, screen, stats):
        ...
        self.prep_score()  # 设置初始得分板
        self.prep_high_score()  # 设置最高得分板
        self.prep_level()  # 设置等级板
        self.prep_ships()  # 设置剩余飞船数显示板

    def prep_score(self):
        """将得分转换为图像"""
        rounded_score = int(round(self.stats.score, -1))  # 得分显示为10的整数倍
